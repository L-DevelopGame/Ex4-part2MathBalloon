...
public class ShieldThePlayer : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.tag == "Player")
        {
            ...
            var destroyComponent = other.GetComponent<DestroyAfterHits>();
            var inputMover = other.GetComponent<InputMover>();
    ...
    private IEnumerator ShieldTemporarily(DestroyAfterHits destroyComponent)
    {   // co-routines
